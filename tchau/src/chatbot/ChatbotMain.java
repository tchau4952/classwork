...
public class ChatbotMain 
{
	 ...
	 * @param keyword
	 * @param startPsn
	 * @return the index of the keyword after startPsn 
	 * that is isolated and has no negations or -1 otherwise
	 */
	public static int findKeyword(String searchString, String keyword, int startPsn)
	{
		...
		while(psn >= 0)
		{
			if(keywordIsIsolated(psn,keyboard,searchString) && noNegations(searchString, psn))
			{
				return psn;
			}
			else
